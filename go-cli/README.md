...
AQL-driven CLI and REPL for the StarWarsDatabank SDK. Positional arguments are
...
```sh
go build -o star-wars-databank-cli ./...
```
...
./star-wars-databank-cli load 1 character
./star-wars-databank-cli load '{id:1}' character
