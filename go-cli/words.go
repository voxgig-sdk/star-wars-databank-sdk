...
func registerSDKWords(r *eng.Registry, client *sdk.StarWarsDatabankSDK) {
...
func runOp(client *sdk.StarWarsDatabankSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
