// Command StarWarsDatabank-cli is a CLI + REPL for the StarWarsDatabank SDK,
...
const prompt = "star-wars-databank"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "character creature droid location organization species vehicle"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      STAR_WARS_DATABANK_APIKEY (api key), STAR_WARS_DATABANK_BASE (base url override)")
