// Command StarWarsDatabank-mcp is an MCP server exposing the StarWarsDatabank
// SDK as MCP tools.
//
// Two tools are registered:
//
//	StarWarsDatabank_list  — list records of an entity
//	StarWarsDatabank_load  — load a single record of an entity
//
