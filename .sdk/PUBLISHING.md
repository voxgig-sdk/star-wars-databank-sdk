...
|---|---|---|
| `ts/` | @voxgig-sdk/star-wars-databank-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/star-wars-databank-sdk \
      --repository voxgig-sdk/star-wars-databank-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/star-wars-databank-sdk` shows it, and
`npm trust revoke @voxgig-sdk/star-wars-databank-sdk --id=<id>` removes it.
