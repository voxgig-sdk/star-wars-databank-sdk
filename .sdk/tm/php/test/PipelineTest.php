...
// StarWarsDatabank SDK pipeline test
//
...
{
    private static function utility(): StarWarsDatabankUtility
    {
        return new StarWarsDatabankUtility();
    }
    ...
    private static function ctx(array $over = []): StarWarsDatabankContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new StarWarsDatabankContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new StarWarsDatabankOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof StarWarsDatabankError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new StarWarsDatabankOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = StarWarsDatabankMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new StarWarsDatabankOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = StarWarsDatabankMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new StarWarsDatabankOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = StarWarsDatabankMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new StarWarsDatabankSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = StarWarsDatabankMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new StarWarsDatabankResponse([]),
            'result' => new StarWarsDatabankResult([]),
        ]);
        [, $err] = StarWarsDatabankMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new StarWarsDatabankSpec([]),
            'response' => null,
            'result' => new StarWarsDatabankResult([]),
        ]);
        [, $err] = StarWarsDatabankMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new StarWarsDatabankSpec(['step' => 's']),
            'response' => new StarWarsDatabankResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new StarWarsDatabankResult([]),
        ]);
        [, $err] = StarWarsDatabankMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new StarWarsDatabankSpec(['step' => 's']),
            'response' => new StarWarsDatabankResponse(self::resp(200, ['v' => 1])),
            'result' => new StarWarsDatabankResult([]),
        ]);
        [, $err] = StarWarsDatabankMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new StarWarsDatabankSpec(['step' => 's']),
            'response' => new StarWarsDatabankResponse(self::resp(200, ['v' => 2])),
            'result' => new StarWarsDatabankResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        StarWarsDatabankMakeResponse::call($ctx);
    ...
    {
        $preset = new StarWarsDatabankResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new StarWarsDatabankSpec([]),
            'response' => new StarWarsDatabankResponse([]),
            'result' => new StarWarsDatabankResult([]),
        ...
        [$got, $err] = StarWarsDatabankMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new StarWarsDatabankResult([])]);
        [, $err] = StarWarsDatabankMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new StarWarsDatabankSpec([]), 'result' => null]);
        [, $err] = StarWarsDatabankMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new StarWarsDatabankSpec(['step' => 's']),
            'result' => new StarWarsDatabankResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new StarWarsDatabankOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = StarWarsDatabankMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new StarWarsDatabankSpec(['step' => 's']),
            'result' => new StarWarsDatabankResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new StarWarsDatabankOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = StarWarsDatabankMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new StarWarsDatabankResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new StarWarsDatabankSpec([]),
            'result' => new StarWarsDatabankResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = StarWarsDatabankMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = StarWarsDatabankMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new StarWarsDatabankError('boom', 'boom');
        $utility->fetcher = function (StarWarsDatabankContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new StarWarsDatabankSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = StarWarsDatabankMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (StarWarsDatabankContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = StarWarsDatabankMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(StarWarsDatabankResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        StarWarsDatabankMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (StarWarsDatabankContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new StarWarsDatabankSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = StarWarsDatabankMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new StarWarsDatabankResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new StarWarsDatabankSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = StarWarsDatabankMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = StarWarsDatabankMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = StarWarsDatabankMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new StarWarsDatabankResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, StarWarsDatabankDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new StarWarsDatabankResult(['ok' => false])]);
        $this->expectException(StarWarsDatabankError::class);
        StarWarsDatabankDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new StarWarsDatabankResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', StarWarsDatabankMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        StarWarsDatabankMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new StarWarsDatabankBaseFeature();
        $b = new StarWarsDatabankBaseFeature();
        StarWarsDatabankFeatureAdd::call($ctx, $a);
        StarWarsDatabankFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): StarWarsDatabankBaseFeature
    {
        $f = new StarWarsDatabankBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        StarWarsDatabankFeatureAdd::call($ctx, self::named_feature('a'));
        StarWarsDatabankFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        StarWarsDatabankFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        StarWarsDatabankFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        StarWarsDatabankFeatureAdd::call($ctx, $replace);
        ...
        StarWarsDatabankFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): StarWarsDatabankContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new StarWarsDatabankSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = StarWarsDatabankPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        StarWarsDatabankPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new StarWarsDatabankResponse(['headers' => null]),
            'result' => new StarWarsDatabankResult([]),
        ]);
        StarWarsDatabankResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        StarWarsDatabankResultBody::call($ctx);
