...
// StarWarsDatabank SDK streaming feature
...
class StarWarsDatabankStreamingFeature extends StarWarsDatabankBaseFeature
{
    ...
    private function _iterate(StarWarsDatabankResult $result): \Generator
    {
    ...
    private function _streamable(StarWarsDatabankContext $ctx): bool
    {
