...
// StarWarsDatabank SDK debug feature
...
class StarWarsDatabankDebugFeature extends StarWarsDatabankBaseFeature
{
    ...
    private function _finish(StarWarsDatabankContext $ctx, bool $ok): void
    {
