...
// StarWarsDatabank SDK ratelimit feature
...
class StarWarsDatabankRatelimitFeature extends StarWarsDatabankBaseFeature
{
    ...
    private function _acquire(StarWarsDatabankContext $ctx): void
    {
    ...
    private function _track(StarWarsDatabankContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
