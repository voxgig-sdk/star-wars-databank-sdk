...
// StarWarsDatabank SDK clienttrack feature
...
class StarWarsDatabankClienttrackFeature extends StarWarsDatabankBaseFeature
{
    ...
    public function PostConstruct(StarWarsDatabankContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'StarWarsDatabank-SDK';
