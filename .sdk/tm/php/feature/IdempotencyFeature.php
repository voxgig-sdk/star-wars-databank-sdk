...
// StarWarsDatabank SDK idempotency feature
...
class StarWarsDatabankIdempotencyFeature extends StarWarsDatabankBaseFeature
{
    ...
    private function _mutating(StarWarsDatabankContext $ctx): bool
    {
