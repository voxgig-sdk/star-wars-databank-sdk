...
// StarWarsDatabank SDK rbac feature
...
class StarWarsDatabankRbacFeature extends StarWarsDatabankBaseFeature
{
    ...
    private function _required(StarWarsDatabankContext $ctx): ?string
    {
    ...
    private function _reject(StarWarsDatabankContext $ctx, string $required): void
    {
    ...
    private function _track(StarWarsDatabankContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
