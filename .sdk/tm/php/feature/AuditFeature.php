...
// StarWarsDatabank SDK audit feature
...
class StarWarsDatabankAuditFeature extends StarWarsDatabankBaseFeature
{
    ...
    private function _emit(StarWarsDatabankContext $ctx, string $outcome): void
    {
