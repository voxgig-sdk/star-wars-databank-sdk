...
// StarWarsDatabank SDK utility: graphql
//
...
class StarWarsDatabankGraphql
{
    ...
    // equivalent.
    public static function body(StarWarsDatabankContext $ctx): mixed
    {
    ...
    public static function errors(StarWarsDatabankContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
