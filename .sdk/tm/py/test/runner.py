...
class StarWarsDatabankTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = StarWarsDatabankTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = StarWarsDatabankTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = StarWarsDatabankTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
