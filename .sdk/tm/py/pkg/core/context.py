...
from projectname_sdk.core.control import StarWarsDatabankControl
...
class StarWarsDatabankContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = StarWarsDatabankControl()
        ...
        if isinstance(sp, StarWarsDatabankSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, StarWarsDatabankResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, StarWarsDatabankResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return StarWarsDatabankOperation({})
    ...
    def make_error(self, code, msg):
        return StarWarsDatabankError(code, msg, self)
