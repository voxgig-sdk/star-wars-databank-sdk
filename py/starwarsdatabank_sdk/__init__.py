...
from starwarsdatabank_sdk.utility import register

# Load features
from starwarsdatabank_sdk.feature.base_feature import StarWarsDatabankBaseFeature
from starwarsdatabank_sdk.features import _has_feature, _make_feature
...
class StarWarsDatabankSDK:
    ...
    def _op_denied(self, op):
        ...
        return {
            "ok": False,
            "err": Exception(
                "StarWarsDatabankSDK: " + op + ": operation not allowed by"
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("StarWarsDatabankSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Character(self, data=None) -> "CharacterEntity":
        ...
        from starwarsdatabank_sdk.entity.character_entity import CharacterEntity
    ...
    def Creature(self, data=None) -> "CreatureEntity":
        ...
        from starwarsdatabank_sdk.entity.creature_entity import CreatureEntity
        return CreatureEntity(self, data)


    def Droid(self, data=None) -> "DroidEntity":
        """Entity factory: client.Droid().list() / client.Droid().load({"id": ...})."""
        from starwarsdatabank_sdk.entity.droid_entity import DroidEntity
    ...
    def Location(self, data=None) -> "LocationEntity":
        ...
        from starwarsdatabank_sdk.entity.location_entity import LocationEntity
    ...
    def Organization(self, data=None) -> "OrganizationEntity":
        ...
        from starwarsdatabank_sdk.entity.organization_entity import OrganizationEntity
    ...
    def Species(self, data=None) -> "SpeciesEntity":
        ...
        from starwarsdatabank_sdk.entity.species_entity import SpeciesEntity
    ...
    def Vehicle(self, data=None) -> "VehicleEntity":
        ...
        from starwarsdatabank_sdk.entity.vehicle_entity import VehicleEntity
