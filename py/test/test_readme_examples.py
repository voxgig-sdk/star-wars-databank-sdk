# StarWarsDatabank SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions StarWarsDatabankSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both StarWarsDatabankSDK(...) and StarWarsDatabankSDK.test(...) become
#      StarWarsDatabankSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "starwarsdatabank_sdk"
_SDK_CLASS = "StarWarsDatabankSDK"
