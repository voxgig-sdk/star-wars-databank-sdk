...
func NewDroidEntity(client *core.StarWarsDatabankSDK, entopts map[string]any) *DroidEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DroidEntity) GetName() string { return e.name }
...
func (e *DroidEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DroidEntity) Deleted() bool {
	return e.deleted
}


func (e *DroidEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDroidEntity(e.client, opts)
}

func (e *DroidEntity) Data(args ...any) any {
...
func (e *DroidEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Droid; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DroidEntity) DataTyped(data ...Droid) Droid {
	if len(data) > 0 {
		return typedFrom[Droid](e.Data(asMap(data[0])))
	}
	return typedFrom[Droid](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Droid (all fields
// optional at the wire level).
func (e *DroidEntity) MatchTyped(match ...Droid) Droid {
	if len(match) > 0 {
		return typedFrom[Droid](e.Match(asMap(match[0])))
	}
	return typedFrom[Droid](e.Match())
}
...
func (e *DroidEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DroidEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DroidLoadMatch and returns an Droid. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *DroidEntity) LoadTyped(reqmatch DroidLoadMatch, ctrl map[string]any) (Droid, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Droid{}, err
	}
	return typedFrom[Droid](res), nil
}




func (e *DroidEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// DroidListMatch and returns []Droid. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *DroidEntity) ListTyped(reqmatch DroidListMatch, ctrl map[string]any) ([]Droid, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Droid](res), nil
}



func (e *DroidEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DroidEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DroidEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DroidEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
