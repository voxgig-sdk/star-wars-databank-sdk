...
type StarWarsDatabankSDK struct {
	Mode     string
...
func (sdk *StarWarsDatabankSDK) OptionsMap() map[string]any {
...
func (sdk *StarWarsDatabankSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *StarWarsDatabankSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *StarWarsDatabankSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *StarWarsDatabankSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *StarWarsDatabankSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *StarWarsDatabankSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("StarWarsDatabankSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *StarWarsDatabankSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *StarWarsDatabankSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("StarWarsDatabankSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *StarWarsDatabankSDK {
	...
	sdk := NewStarWarsDatabankSDK(sdkopts)
	sdk.Mode = "test"
