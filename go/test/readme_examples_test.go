...
const testSeed = `map[string]any{"entity": map[string]any{"character": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "creature": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "droid": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "location": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "organization": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "species": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "vehicle": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
