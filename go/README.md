...
The Golang SDK for the StarWarsDatabank API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/star-wars-databank-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/star-wars-databank-sdk=../path/to/github.com/voxgig-sdk/star-wars-databank-sdk
```
...
| `Organization` | `(data map[string]any) StarWarsDatabankEntity` | Create a Organization entity instance. |
...
```
github.com/voxgig-sdk/star-wars-databank-sdk/
...
The root package (`github.com/voxgig-sdk/star-wars-databank-sdk`) re-exports everything needed
