...
// StarWarsDatabank SDK paging feature
...
class StarWarsDatabankPagingFeature extends StarWarsDatabankBaseFeature
{
    ...
    private function _is_list(StarWarsDatabankContext $ctx): bool
    {
