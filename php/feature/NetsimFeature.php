...
// StarWarsDatabank SDK netsim feature
...
class StarWarsDatabankNetsimFeature extends StarWarsDatabankBaseFeature
{
    ...
    private function _simulate(StarWarsDatabankContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(StarWarsDatabankContext $ctx, array $applied): void
    {
        $client = $this->client;
