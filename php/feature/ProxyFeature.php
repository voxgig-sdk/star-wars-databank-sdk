...
// StarWarsDatabank SDK proxy feature
...
class StarWarsDatabankProxyFeature extends StarWarsDatabankBaseFeature
{
    ...
    public function init(StarWarsDatabankContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (StarWarsDatabankContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
