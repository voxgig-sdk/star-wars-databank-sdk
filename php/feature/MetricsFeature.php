...
// StarWarsDatabank SDK metrics feature
...
class StarWarsDatabankMetricsFeature extends StarWarsDatabankBaseFeature
{
    ...
    private function _record(StarWarsDatabankContext $ctx, bool $ok): void
    {
