...
// StarWarsDatabank SDK cache feature
...
class StarWarsDatabankCacheFeature extends StarWarsDatabankBaseFeature
{
    ...
    private function _through(StarWarsDatabankContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
