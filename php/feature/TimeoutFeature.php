...
// StarWarsDatabank SDK timeout feature
...
class StarWarsDatabankTimeoutFeature extends StarWarsDatabankBaseFeature
{
    ...
    private function _with_timeout(StarWarsDatabankContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(StarWarsDatabankContext $_ctx, float $ms): void
    {
        $client = $this->client;
