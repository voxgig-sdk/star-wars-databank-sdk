...
// StarWarsDatabank SDK telemetry feature
...
class StarWarsDatabankTelemetryFeature extends StarWarsDatabankBaseFeature
{
    ...
    private function _close(StarWarsDatabankContext $ctx, bool $ok): void
    {
