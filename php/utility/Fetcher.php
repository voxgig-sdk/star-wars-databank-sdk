...
// StarWarsDatabank SDK utility: fetcher

class StarWarsDatabankFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; StarWarsDatabankSDK/1.0)';
    ...
    public static function call(StarWarsDatabankContext $ctx, string $fullurl, array $fetchdef): array
    {
