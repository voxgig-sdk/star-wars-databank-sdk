...
// StarWarsDatabank SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class StarWarsDatabankTransformResponse
{
    public static function call(StarWarsDatabankContext $ctx): mixed
    {
        ...
        $transform = StarWarsDatabankHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
