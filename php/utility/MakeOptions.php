...
// StarWarsDatabank SDK utility: make_options

class StarWarsDatabankMakeOptions
{
    ...
    public static function call(StarWarsDatabankContext $ctx): array
    {
        ...
        //
        // `StarWarsDatabankSchema::optspec()` is built from the model:
        ...
        $optspec = StarWarsDatabankSchema::optspec();
