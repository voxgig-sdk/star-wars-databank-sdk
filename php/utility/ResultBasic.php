...
// StarWarsDatabank SDK utility: result_basic

class StarWarsDatabankResultBasic
{
    public static function call(StarWarsDatabankContext $ctx): ?StarWarsDatabankResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof StarWarsDatabankError) ? $result->err->msg : (string)$result->err;
