...
// StarWarsDatabank SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (StarWarsDatabankSDK::test)
...
{
    private const SDK_CLASS = 'StarWarsDatabankSDK';
    ...
    private const SDK_BASE = 'starwarsdatabank_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../starwarsdatabank_sdk.php';
