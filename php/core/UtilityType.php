...
// StarWarsDatabank SDK utility type

class StarWarsDatabankUtility
{
    ...
    public static function copy(StarWarsDatabankUtility $src): StarWarsDatabankUtility
    {
        $u = new StarWarsDatabankUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
