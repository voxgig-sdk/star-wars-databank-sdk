...
(0, node_test_1.describe)('DroidDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-droid', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-droid', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-droid', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-droid', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['STAR_WARS_DATABANK_TEST_DROID_ENTID'];
...
//# sourceMappingURL=DroidDirect.test.js.map