...
(0, node_test_1.describe)('CreatureDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.StarWarsDatabankSDK({
    ...
    (0, node_test_1.test)('direct-load-creature', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-creature', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-creature', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-creature', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function liveScenariosActive() { return false && process.env.STAR_WARS_DATABANK_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.StarWarsDatabankSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['STAR_WARS_DATABANK_TEST_CREATURE_ENTID'];
    ...
    const client = new __1.StarWarsDatabankSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=CreatureDirect.test.js.map