...
(0, node_test_1.describe)('CreatureEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'creature.' + op, live))
                return;
        }
        ...
        let creature_ref01_data = Object.values(setup.data.existing.creature)[0];
        // LIST
        const creature_ref01_ent = client.Creature();
        const creature_ref01_match = {};
        const creature_ref01_list = (await creature_ref01_ent.list(creature_ref01_match)).map((e) => e.data());
        // LOAD
        const creature_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(creature_ref01_data_dt0.id === creature_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/creature/CreatureTestData.json');
    ...
    let idmap = transform(['creature01', 'creature02', 'creature03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['STAR_WARS_DATABANK_TEST_CREATURE_ENTID'];
...
//# sourceMappingURL=CreatureEntity.test.js.map