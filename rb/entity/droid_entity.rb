...
class DroidEntity
  ...
  #   as an empty match, so client.Droid.load works with no args).
  ...
  #
  # @param reqmatch [DroidListMatch, Hash, nil] match filter (any subset of
  #   Droid fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
