# StarWarsDatabank SDK Species entity
...
class SpeciesEntity
  ...
  # @return [Species, Hash] the loaded Species; raises StarWarsDatabankError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Species>, Array] the matching Species items; raises StarWarsDatabankError on failure
