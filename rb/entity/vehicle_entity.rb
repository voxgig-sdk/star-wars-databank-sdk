# StarWarsDatabank SDK Vehicle entity
...
class VehicleEntity
  ...
  # @return [Vehicle, Hash] the loaded Vehicle; raises StarWarsDatabankError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Vehicle>, Array] the matching Vehicle items; raises StarWarsDatabankError on failure
