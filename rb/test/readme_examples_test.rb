...
#      offline in seeded test mode (StarWarsDatabankSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "StarWarsDatabank_sdk.rb")
  SDK_CLASS = "StarWarsDatabankSDK"
