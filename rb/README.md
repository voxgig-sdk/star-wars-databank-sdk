...
The Ruby SDK for the StarWarsDatabank API. Provides an entity-oriented interface using idiomatic Ruby conventions.
...
result, err = client.StarWarsDatabank(nil).load(
  { "id" => "test01" }, nil
)
