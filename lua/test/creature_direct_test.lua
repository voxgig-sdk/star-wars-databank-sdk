...
describe("CreatureDirect", function()
  it("should direct-list-creature", function()
    local setup = creature_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-creature", setup.live and "live" or "unit")
  ...
  it("should direct-load-creature", function()
    local setup = creature_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-creature", setup.live and "live" or "unit")
    if _should_skip then
      pending(_reason or "skipped via sdk-test-control.json")
      return
    end
...
function creature_direct_setup(mockres)
