...
local SDK_MODULE = "star-wars-databank_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["character"] = { ["test01"] = { id = "test01" } }, ["creature"] = { ["test01"] = { id = "test01" } }, ["droid"] = { ["test01"] = { id = "test01" } }, ["location"] = { ["test01"] = { id = "test01" } }, ["organization"] = { ["test01"] = { id = "test01" } }, ["species"] = { ["test01"] = { id = "test01" } }, ["vehicle"] = { ["test01"] = { id = "test01" } } } }'
