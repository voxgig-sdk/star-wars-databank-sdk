...
describe("DroidDirect", function()
  it("should direct-list-droid", function()
    local setup = droid_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-droid", setup.live and "live" or "unit")
  ...
  it("should direct-load-droid", function()
    local setup = droid_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-droid", setup.live and "live" or "unit")
    if _should_skip then
      pending(_reason or "skipped via sdk-test-control.json")
      return
    end
...
function droid_direct_setup(mockres)
