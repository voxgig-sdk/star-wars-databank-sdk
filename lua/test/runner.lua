...
function runner.env_override(m)
  local live = runner.getenv("STARWARSDATABANK_TEST_LIVE")
  local override = runner.getenv("STARWARSDATABANK_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("STARWARSDATABANK_TEST_EXPLAIN")
