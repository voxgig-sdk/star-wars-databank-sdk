...
describe("OrganizationEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set STAR_WARS_DATABANK_TEST_ORGANIZATION_ENTID JSON to run live")
      return
    end
...
function organization_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("STAR_WARS_DATABANK_TEST_ORGANIZATION_ENTID")
  ...
  local idmap_resolved = helpers.to_map(
    env["STAR_WARS_DATABANK_TEST_ORGANIZATION_ENTID"])
