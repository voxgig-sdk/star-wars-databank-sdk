...
local function make_error_util(ctx, err)
  ...
  local msg = "StarWarsDatabankSDK: " .. opname .. ": " .. errmsg
  ...
  local sdk_err = StarWarsDatabankError.new("", msg, ctx)
  ...
  if type(err) == "table" and getmetatable(err) == StarWarsDatabankError then
