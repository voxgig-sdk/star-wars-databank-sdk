...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/star-wars-databank` | `npm install @voxgig-sdk/star-wars-databank` |
| Python | `voxgig-sdk-star-wars-databank` | `pip install voxgig-sdk-star-wars-databank` |
| PHP | `voxgig-sdk/star-wars-databank` | `composer require voxgig-sdk/star-wars-databank` |
| Golang | `github.com/voxgig-sdk/star-wars-databank-sdk/go` | `go get github.com/voxgig-sdk/star-wars-databank-sdk/go` |
| Ruby | `voxgig-sdk-star-wars-databank` | `gem install voxgig-sdk-star-wars-databank` |
| Lua | `voxgig-sdk-star-wars-databank` | `luarocks install voxgig-sdk-star-wars-databank` |
